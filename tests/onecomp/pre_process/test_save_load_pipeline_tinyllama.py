...
Usage::
    ...
    pytest tests/onecomp/pre_process/test_save_load_pipeline_tinyllama.py -v -s --log-cli-level=INFO
"""
...
class TestSaveLoadPipelineTinyLlama:
    """Verify save/load round-trip with rotation + quantization (TinyLlama)."""
